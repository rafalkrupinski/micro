...
public class SystemDates {
    /**
     * Convert {@link Instant} to {@link LocalDate} discarding time information, using the system default time zone.
     */
    ...
    /**
     * Convert {@link LocalDateTime} to {@link Instant} with the system default time zone.
     */
